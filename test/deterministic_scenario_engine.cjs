  ...
  return {
    ...
    input: {
      ...
      files: [
        ...
        {
          filename: `test/test_${token}_${index}.py`,
          status: "modified",
          additions: 12,
          deletions: 3,
  ...
  return {
    ...
    input: {
      ...
      files: [
        ...
        {
          filename: `test/test_runtime_${token}_${index}.py`,
          status: "added",
          additions: 24,
          deletions: 0,
  ...
  return {
    ...
    input: {
      ...
      files: [
        ...
        {
          filename: `test/autobot_${token}_${index}.test.cjs`,
          status: "added",
          additions: 24,
          deletions: 0,
  ...
  return {
    ...
    input: {
      ...
      files: [
        ...
        {
          filename: `test/test_${token}_shim_${index}.py`,
          status: "added",
          additions: 16,
          deletions: 0,
  ...
  return {
    ...
    input: {
      ...
      files: [
        ...
        {
          filename: `test/test_${token}_migration_${index}.py`,
          status: "added",
          additions: 18,
          deletions: 0,
  ...
  return {
    ...
    input: {
      ...
      files: [
        ...
        {
          filename: "test/javascript_test_harness.cjs",
          status: "modified",
          additions: 24,
          deletions: 8,
          patch: [
        ...
        {
          filename: `test/test_${token}_fixture_${index}.py`,
          status: "added",
          additions: 28,
          deletions: 0,
      ...
      files: [
        ...
        },
        {
          ...
          patch: [
            ...
            "+        run: node --test test/autobot_adversarial.test.cjs",
            "+    uses: actions/github-script@v9",
